...
export const LEVELS = {
    ...
    4: {
        ...
        decorations: [
            ...
            { type: 'tombstone2', x: 160, y: GAME_HEIGHT - 185, scale: 1.1, label: "Windows ME" }, // Adjusted
        ...
        collectibles: [
            ...
            { x: 740, y: GAME_HEIGHT - 390 }, // Adjusted
        ...
        enemies: [
            ...
            { x: 760, y: GAME_HEIGHT - 390, type: 'skeleton', minX: 730, maxX: 810, hp: 2 }, // Adjusted
    ...
    5: {
        ...
        collectibles: [
            { x: 250, y: GAME_HEIGHT - 220 }, // Adjusted
            { x: 480, y: GAME_HEIGHT - 320 }, // Adjusted
            { x: 650, y: GAME_HEIGHT - 430 }, // Adjusted
        ...
        enemies: [
            { x: 280, y: GAME_HEIGHT - 220, type: 'skeleton', minX: 230, maxX: 380, hp: 2 }, // Adjusted
